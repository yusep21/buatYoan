...
// Dirubah 
const pengirim = "Batre";
const nomorWa = "6287789923806" // awalan nomor harus 62
const textWa = "Yaudah hayu gassinn gak sih "
const pesan = `Gatau mau ngomong apa, cuman mau mastiin soal kamu sama aku, kita ini pacaran atau gimana? kalo enggak yaudah hayu pacaran mau ga?`;
...
hilang1.addEventListener('click', () => {
  ...
  Swal.fire({
    ...
    imageHeight: 120,
    title: 'Masukin Nama Kamu, ada sesuatu ',
    ...
    let txt = `Holla ${result.value.login},  ${pesan}`;
